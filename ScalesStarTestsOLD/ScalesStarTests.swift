...
final class ScalesStarTests: XCTestCase {
    ...
    func testExample() throws {
        ...
        scalesModel.setScaleByRootAndType(scaleRoot: ScaleRoot(name: "C"), scaleType: .chromatic,
                                        ...
                                        debugOn: true, unitTest: true)
        let score = scalesModel.getScore()
        print("============", score?.timeSignature.top)
