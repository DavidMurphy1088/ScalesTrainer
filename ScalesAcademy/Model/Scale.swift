...
public class Scale : Codable {
    ...
    func getBackingChords() -> BackingChords? {
        ...
        let transposedChords = BackingChords(scaleType: self.scaleType)
        var rootPitch:Int
    ...
    func getHandsDescription() -> String {
        ...
        return hands[0] == 1 ? "LeftHand" : "RightHand"
    }
...
//                }
    ...
    func getHighPointIndex(hand:Int) -> Int {
        ...
        for i in 0..<self.scaleNoteState[hand].count {
            let noteState = self.scaleNoteState[0][i]
            if noteState.midi > maxMidi {
                maxMidi = noteState.midi
                highPointIndex = i
            }
        }
    ...
    func setFingers(hand:Int) {
        ...
        ///Fingering is the fingers in the specified array
...
//            }
    ...
    func getScaleIdentificationKey() -> String {
        var key = scaleRoot.name + "_" + scaleType.description + "_Oct_" + String(self.octaves)
        + "_" + self.scaleMotion.description + "_" + self.getHandsDescription()
