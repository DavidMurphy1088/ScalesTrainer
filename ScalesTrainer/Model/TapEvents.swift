...
public class TapEvent:Hashable {
    ...
    let scaleMidi:Int ///The scale midi expected next
    let amplitude:Float
    ...
    public init(tapNum:Int, onKeyboard:Bool, scaleMid:Int, midi:Int, tapMidi:Int, amplitude:Float, pressedKey: Bool, amplDiff:Double, ascending: Bool, key:PianoKeyModel?) {
        self.tapNum = tapNum
        self.midi = midi
        self.scaleMidi = scaleMid
