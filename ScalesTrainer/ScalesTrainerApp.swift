        ...
        if Settings.shared.settingsExists() {
            if Settings.shared.calibrationIsSet() {
                if Settings.shared.isDeveloperMode() {
                    ...
                    ScalesModel.shared.setScaleByRootAndType(scaleRoot: ScaleRoot(name: "C"), scaleType: .harmonicMinor, scaleMotion: .similarMotion, minTempo: 70, octaves: 2, hands: [0,1], ctx: "App Start")
                    selectedTab = 0
                }
                else {
                    selectedTab = 1
